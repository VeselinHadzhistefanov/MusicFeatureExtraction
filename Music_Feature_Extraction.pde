...
String[] sourcePaths = { "jazzguitar2_3.mp3", "guitar1.wav", "guitarnotes2.wav", "violin3.wav", "sax1.wav", "piano2.mp3" };

String[] sourceNames = {"Notes 1", "Notes 2", "Notes 3", "Notes 4", "Notes 5", "Notes 6"};

String[] instrumentPaths = { "pianonote3_2.mp3", "guitarPluck_2.mp3", "chime1.wav", "violinnote3.wav", "tanbura2.aiff", "guitarPluck_2.mp3"};
